...
- In the terminal enter "npm install" to install the needed modules. Then run the application by typing "node index.js" and follow the prompts.
...
## Test Instructions
- After installing all the dependencies for JEST the user can run npm test in the terminal.
